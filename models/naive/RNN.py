...
class VanillaRNN(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, output_size):
        ...
        self.hl = nn.Linear(self.input_size + self.hidden_size, self.hidden_size)
        self.ol = nn.Linear(self.input_size + self.hidden_size, self.output_size)
    ...
    def forward(self, input, hidden):
        ...
        hidden = self.hl(concat)
        output = self.ol(concat)
